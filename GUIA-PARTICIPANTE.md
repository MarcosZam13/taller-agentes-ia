...
| Qué | Dónde | Cómo |
|---|---|---|
| 🔑 **API key de OpenRouter** | [openrouter.ai](https://openrouter.ai) | Registrate → **Keys** → *Create Key* → copiá el `sk-or-...` (para el taller usás la key compartida que te pasa el facilitador) |
...
**un** caso y le das una herramienta real. Corré **solo uno** de estos comandos
desde la carpeta del proyecto (Windows: usá el `.ps1` en PowerShell):
