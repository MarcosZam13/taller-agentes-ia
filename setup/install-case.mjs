...
const CASES = {
  ...
  "second-brain": {
    ...
    routing: [
      ...
      "| pide el **resumen diario** (\"generame el resumen\", \"qué tengo hoy\", \"qué hay pendiente\") — un solo comando que junta agenda + pendientes; NO inventes subcomandos ni flags como --mes | `node ~/.openclaw/workspace/skills/second-brain/brain.js summary` |",
      "| pregunta **qué se viene / próximas citas / pagos / qué tengo que hacer** (agenda incluye una sección **⚠️ Atrasados** si hay vencidos sin hacer) | `node ~/.openclaw/workspace/skills/second-brain/brain.js agenda` (con fecha) y `node ~/.openclaw/workspace/skills/second-brain/brain.js pendientes` (sin fecha) |",
      ...
      "| quiere **reprogramar / mover / posponer** algo a otra fecha (\"movelo al 15\", \"pasá el pago para…\") | `node ~/.openclaw/workspace/skills/second-brain/brain.js due \"<titulo>\" \"YYYY-MM-DD[ HH:MM]\"` |",
